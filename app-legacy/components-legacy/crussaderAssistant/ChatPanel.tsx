// app/components/crussaderAssistant/ChatPanel.tsx
"use client";

import { useEffect, useMemo, useRef } from "react";
import IncomingMessageBubble from "@/app-legacy/components-legacy/crussaderAssistant/IncomingMessageBubble";
import OutgoingMessageBubble from "@/app-legacy/components-legacy/crussaderAssistant/OutgoingMessageBubble";
...
export default function ChatPanel({
  ...
  events?: AssistantChatEvent[] | null | unknown;
  className?: string;
}) {
  const safeEvents: AssistantChatEvent[] = Array.isArray(events) ? (events as AssistantChatEvent[]) : [];
