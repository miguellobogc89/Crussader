// app/components/crussaderAssistant/ContactsPanel/CustomersListPanel.tsx
"use client";

import { Separator } from "@/app/components/ui/separator";
import ScrollBar from "@/app/components/crussader/UX/ScrollBar";
import SearchBar from "@/app-legacy/components-legacy/crussaderAssistant/ContactsPanel/SearchBar";
import ConversationRowItem from "@/app-legacy/components-legacy/crussaderAssistant/ContactsPanel/ConversationRowItem";
import { useCrussaderAssistantContacts } from "@/app-legacy/components-legacy/crussaderAssistant/hooks/useCrussaderAssistantContacts";
...
async function markConversationRead(args: { companyId: string; conversationId: string }) {
  const res = await fetch("/api/crussader-assistant/conversations/read", {
    method: "POST",
...
export default function CustomersListPanel({
  ...
  const model = useCrussaderAssistantContacts({
    companyId,
