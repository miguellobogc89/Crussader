...
import ChatPanel from "@/app-legacy/components-legacy/crussaderAssistant/ChatPanel";
import CustomersListPanel from "@/app-legacy/components-legacy/crussaderAssistant/ContactsPanel/CustomersListPanel";
import ConversationHeader from "@/app-legacy/components-legacy/crussaderAssistant/ConversationHeader";
import type { AssistantChatEvent } from "@/app-legacy/components-legacy/crussaderAssistant/hooks/useCrussaderAssistantChatEvents";
import type { AssistantConversationContact } from "@/app-legacy/components-legacy/crussaderAssistant/CrussaderAssistantShell";
