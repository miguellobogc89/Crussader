...
"  'Cliente menciona tiempos de espera largos'.",
    ...
    "",
"REGLAS PARA aspect:",
"- aspect debe ser una dimensión evaluable y NEUTRA, en forma de SUSTANTIVO o sintagma nominal corto.",
"- PROHIBIDO meter juicio, adjetivos o intensidad dentro de aspect (p.ej. 'amable', 'excelente', 'muy caro', 'rápido', 'lento').",
"- Si hay adjetivo/valoración, colócalo en descriptor y refleja la polaridad en judgment + intensity.",
"- Evita 'general', 'todo', 'experiencia general'.",
"- No uses 'servicio' como aspect; si la idea es humana, usa aspect tipo 'amabilidad', 'profesionalidad' o 'resolución'.",
"- Ejemplos correctos:",
"  aspect='servicio al cliente', descriptor='amable', judgment='positive'",
"  aspect='precio', descriptor='muy caro', judgment='negative'",
"  aspect='tiempo de espera', descriptor='largo', judgment='negative'",
"",
