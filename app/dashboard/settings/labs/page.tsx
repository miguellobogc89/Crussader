    ...
    <div className="space-y-8">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="space-y-2">
              <h3 className="font-semibold text-amber-800 dark:text-amber-200">
                ⚠️ Funcionalidades experimentales
              </h3>
              <p className="text-sm text-amber-700 dark:text-amber-300">
                Estas funciones están en desarrollo activo y pueden tener errores o
                comportamientos inesperados. Úsalas bajo tu propia responsabilidad y no
                olvides reportar cualquier problema que encuentres.
              </p>
            </div>
          </div>
        </CardContent>
      ...
      <Card className="rounded-2xl shadow-sm">
        <CardHeader>
          ...
          <CardDescription>
            Activa las funciones que quieres probar. Puedes desactivarlas en cualquier momento.
          </CardDescription>
        </CardHeader>
      ...
      <Card className="rounded-2xl shadow-sm">
        <CardHeader>
          ...
          <CardDescription>
            Comparte tu experiencia con las funciones experimentales. Tu feedback es muy valioso
