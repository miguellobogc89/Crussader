...
const isConverted = hasRecoverySlot && normalizedStatus === "CANCELLED";

const effectiveStatusConfig = isConverted
  ? {
      label: "Convertida",
      className: "text-emerald-700",
      icon: CheckCircle2,
...
const isCancelled = normalizedStatus === "CANCELLED" && !isConverted;
...
{effectiveStatusConfig && StatusIcon ? (
  <span
    className={[
      ...
      effectiveStatusConfig.className,
    ].join(" ")}
  >
