// app/components/calendar/CalendarOnly/MonthView.tsx
"use client";
...
export default function MonthView({ anchor, appts, onSelect, onEdit, painter }: Props) {
  ...
  return (
    <div className="grid grid-cols-7 gap-[6px]">
      {["Lun", "Mar", "Mié", "Jue", "Vie", "Sáb", "Dom"].map((h) => (
        <div key={h} className="text-xs text-muted-foreground px-1 py-1">
          {h}
        </div>
      ))}
