    ...
    <div className="space-y-4">
      ...
      >
        <div className="flex items-start gap-3">
          ...
          {/* Icono empresa */}
          <img
            src="/icon/office-building.png"
            alt="Crear empresa"
            className="mt-0.5 h-8 w-8 opacity-80"
          />
      ...
      >
        <div className="flex items-start gap-3">
          ...
          {/* Icono acceso */}
          <img
            src="/icon/access-control.png"
            alt="Solicitar acceso"
            className="mt-0.5 h-8 w-8 opacity-80"
          />
          ...
          <div>
            ...
            <div className="mt-1 text-sm text-slate-600">
              Enviaremos una solicitud al administrador de tu empresa para que te invite.
            </div>
          </div>
        </div>
      </button>
