      ...
      {services.map((service) => {
        ...
        return (
          <button
            ...
            className={
              isSelected
                ? "inline-flex items-center rounded-full border border-sky-300 bg-sky-100 px-3 py-1 text-xs font-semibold text-sky-800 transition"
          ...
          >
            ...
            <span className="ml-1 rounded-full bg-white/70 px-1.5 py-0.5 text-[12px] font-semibold text-slate-600">
