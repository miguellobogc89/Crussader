  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as Bucket)} className="w-full sm:w-auto">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <SelectContent>
              {activeTab === "1-2" && <SelectItem value="apology">🙇 Disculpa / solución</SelectItem>}
              {activeTab === "3" && <SelectItem value="neutral">🧭 Neutral / explicación</SelectItem>}
              {activeTab === "4-5" && <SelectItem value="thanks">🎁 Agradecimiento / fidelización</SelectItem>}
            </SelectContent>
          </Select>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-8 mt-6">
        ...
        <div className="flex justify-between items-center">
          <div className="text-sm text-muted-foreground">
            Máx. caracteres:&nbsp;<span className="font-medium">{autoLimit}</span>
          </div>
